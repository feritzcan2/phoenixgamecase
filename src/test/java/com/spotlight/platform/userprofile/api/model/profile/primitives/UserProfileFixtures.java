...
public class UserProfileFixtures {
    ...
    public static  final UserProfile USER_PROFILE_COMMAND = new UserProfile(USER_ID, LAST_UPDATE_TIMESTAMP,
            new HashMap<>(Map.of(UserProfilePropertyName.valueOf("property1"), UserProfilePropertyValue.valueOf("property1Value"))));

    public static  UserProfile USER_PROFILE_INCREMENTED= new UserProfile(USER_ID, LAST_UPDATE_TIMESTAMP,
            new HashMap<>(Map.of(UserProfilePropertyName.valueOf("property1"), UserProfilePropertyValue.valueOf("property1Value")
